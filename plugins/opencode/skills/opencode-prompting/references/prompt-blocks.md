...
Use these blocks selectively when composing opencode or GPT-5.4 prompts.
...
Use when opencode should act without asking routine questions.
...
Use when opencode might otherwise guess.
