...
- `<default_follow_through_policy>`: what opencode should do by default instead of asking routine questions.
...
- Write-capable tasks: add `action_safety` so opencode stays narrow and avoids unrelated refactors.
